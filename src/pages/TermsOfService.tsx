      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-white/80 backdrop-blur-lg border border-gray-200 rounded-xl p-8 md:p-12 shadow-sm">
          ...
          <div className="space-y-8 text-sm">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">4. Trading Rules</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">5. Risk Disclosure</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-gray-900">6. Fees and Charges</h2>
              <p className="text-gray-700 leading-relaxed">
